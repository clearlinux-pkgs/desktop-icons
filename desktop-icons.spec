...
Source0  : https://gitlab.gnome.org/World/ShellExtensions/desktop-icons/-/archive/19.01.3/desktop-icons-19.01.3.tar.gz
...
%prep
%setup -q -n desktop-icons-19.01.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1556922081
